...
const operationsDoc = `query Issues($owner: String = "Fran-A-Dev", $name: String = "netlifygraph-ghub") @netlify(id: """ed63a33f-d792-4f20-886c-6970a96c134a""", doc: """An example query to start with.""") {
  gitHub {
